      ...
      <div className="max-w-7xl mx-auto px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="group cursor-pointer">
            ...
            <h3 className="text-2xl font-bold font-display mb-2 group-hover:text-primary transition-colors">The Digital Soul</h3>
          ...
          <div className="group cursor-pointer">
            ...
            <h3 className="text-2xl font-bold font-display mb-2 group-hover:text-primary transition-colors">Faxlab Chronicles</h3>
